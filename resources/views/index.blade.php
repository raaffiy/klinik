        ...
        <div class="container">
          <div
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <p>
                <a href="/menu" class="btn btn-primary p-3 px-xl-4 py-xl-3"
                  >Order Now</a
                >
                <a
                  href="/blog"
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
        <div class="row">
        @foreach ($latteProducts as $key => $product)
                <?php
            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <ul
                ...
                <li class="ftco-animate">
                  <a href="https://github.com/raaffiy"><span class="icon-github"></span></a>
                </li>
                <li class="ftco-animate">
                  <a href="https://www.linkedin.com/in/maulana-ra-afi-457414232/"><span class="icon-linkedin"></span></a>
                </li>
                <li class="ftco-animate">
                  <a href="https://www.instagram.com/rafy_998?igsh=dXIyY29raXo5cW1u"><span class="icon-instagram"></span></a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li>
                    ...
                    ><span class="text"
                      >Rawalumbu, Kota Bekasi, Jawa Barat, Jembatan 8</span
                    >
                  </li>
                  <li>
                    <a href="#"
                      ><span class="icon icon-phone"></span
                      ><span class="text">(+62) 857 - 1471 - 3706</span></a
                    >
                  </li>
                  <li>
                    <a href="#"
                      ><span class="icon icon-envelope"></span
                      ><span class="text">raafimaulana43@gmail.com</span></a
                    >
                  </li>
                </ul>
              </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p>
              ...
              <a href="https://colorlib.com" target="_blank">Rafi</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
        </div>
