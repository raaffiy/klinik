          ...
          <section id="blog-details" class="blog-details section">
            <div class="container">
              ...
              <article class="article">
                ...
                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="/news-details">John Doe</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="/news-details"><time datetime="2020-01-01">Jan 1, 2022</time></a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="/news-details">12 Comments</a></li>
                  </ul>
                </div><!-- End meta top -->
