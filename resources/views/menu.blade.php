	    		...
	    		<div class="col-lg-12 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
		            <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
		            	<a class="nav-link active" id="v-pills-0-tab" data-toggle="pill" href="#v-pills-0" role="tab" aria-controls="v-pills-0" aria-selected="true">Espresso</a>

		              	<a class="nav-link" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="false">Americano</a>

		              	<a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">Cappuccino</a>

		              	<a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">Latte</a>
					
						<a class="nav-link" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab" aria-controls="v-pills-4" aria-selected="false">Mocha</a>
		            </div>
		          </div>
						            ...
						            <div class="col-md-3">
						                <div class="menu-entry">
						                    <a href="/product-single/{{ $productId }}"> <!-- Pass product ID as a parameter in the URL -->
						                        <img src="{{ $image_product_path }}" alt="{{ $name }}" class="img-fluid">
						                    </a>
